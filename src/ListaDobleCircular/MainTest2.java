...
public class MainTest2 {
    public static void main(String[] args) {
        ListaDobleCircular<Double> lista1 = new ListaDobleCircular<>();
        ...
        **/
        ...
        lista1.insertarOrdenado(1.5);
        lista1.insertarOrdenado(2.3);
        lista1.insertarOrdenado(1.1);
        lista1.insertarOrdenado(3.7);
